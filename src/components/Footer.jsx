            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-blue-100">ISO 9001:2015</div>
                </div>
              </div>
        ...
        <div className="mt-12 pt-8 border-t border-blue-800/30">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="text-center md:text-right text-xs text-gray-500">
              <p>Accredited by Somali Medical Association</p>
              <p className="mt-1">License No: SMA-2024-001</p>
            </div>
          </div>
        </div>
      </div>
