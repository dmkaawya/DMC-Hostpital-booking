...
import { FaSave, FaCog, FaBell, FaShieldAlt, FaDatabase, FaUserShield, FaCalendarAlt, FaDollarSign, FaHospital } from 'react-icons/fa';
...
const Settings = () => {
  const [settings, setSettings] = useState({
    ...
    hospitalPhone: '+252 61 123 4567',
    hospitalAddress: 'KM4 Airport Road, Mogadishu',
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-[#19456B] to-[#0d2c4a] min-h-screen">
      <div className="mb-8">
        ...
        <p className="text-[#16C79A]/80 mt-2">Configure system preferences and hospital information</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        {/* Left Column - Settings Categories */}
        <div className="lg:col-span-1">
          <div className="bg-gradient-to-br from-[#19456B] to-[#0d2c4a] border border-[#16C79A]/20 rounded-2xl p-6 shadow-xl">
            <div className="flex items-center gap-3 mb-6">
              <FaHospital className="text-[#16C79A] text-xl" />
            ...
            <div className="space-y-2">
              {[
                ...
                <button
                  key={index}
                  className="w-full text-left p-3 hover:bg-gradient-to-r from-[#11698E]/20 to-[#19456B]/20 rounded-lg flex items-center gap-3 transition-all duration-300 group"
                >
                  <item.icon className={`text-${item.color} group-hover:scale-110 transition-transform`} />
                  <span className="text-white group-hover:text-[#16C79A] transition-colors">{item.label}</span>
                </button>
              ))}
            </div>
          </div>
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <div className="bg-gradient-to-br from-[#19456B] to-[#0d2c4a] border border-[#16C79A]/20 rounded-2xl p-6 shadow-xl">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <FaCog className="text-[#16C79A] text-xl" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="label text-[#16C79A]/80">Hospital Name</label>
                <input
                  type="text"
              ...
              <div>
                <label className="label text-[#16C79A]/80">Hospital Email</label>
                <input
                  type="email"
                  className="w-full px-4 py-3 bg-[#0d2c4a] border border-[#16C79A]/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#16C79A]"
              ...
              <div>
                <label className="label text-[#16C79A]/80">Hospital Phone</label>
                <input
                  type="tel"
                  className="w-full px-4 py-3 bg-[#0d2c4a] border border-[#16C79A]/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#16C79A]"
              ...
              <div>
                <label className="label text-[#16C79A]/80">Hospital Address</label>
                <input
                  type="text"
                  className="w-full px-4 py-3 bg-[#0d2c4a] border border-[#16C79A]/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#16C79A]"
          ...
          <div className="bg-gradient-to-br from-[#19456B] to-[#0d2c4a] border border-[#16C79A]/20 rounded-2xl p-6 shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <label className="label text-[#16C79A]/80">Appointment Duration</label>
                <select
                  className="w-full px-4 py-3 bg-[#0d2c4a] border border-[#16C79A]/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#16C79A]"
                  value={settings.appointmentDuration}
                  onChange={(e) => setSettings({...settings, appointmentDuration: parseInt(e.target.value)})}
                >
                  <option value={15} className="bg-[#0d2c4a]">15 minutes</option>
                  <option value={30} className="bg-[#0d2c4a]">30 minutes</option>
                  <option value={45} className="bg-[#0d2c4a]">45 minutes</option>
                  <option value={60} className="bg-[#0d2c4a]">60 minutes</option>
                </select>
              </div>
              
              <div>
                <label className="label text-[#16C79A]/80">Working Hours Start</label>
                <input
                  type="time"
                  className="w-full px-4 py-3 bg-[#0d2c4a] border border-[#16C79A]/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#16C79A]"
              ...
              <div>
                <label className="label text-[#16C79A]/80">Working Hours End</label>
                <input
                  type="time"
                  className="w-full px-4 py-3 bg-[#0d2c4a] border border-[#16C79A]/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#16C79A]"
          ...
          <div className="bg-gradient-to-br from-[#19456B] to-[#0d2c4a] border border-[#16C79A]/20 rounded-2xl p-6 shadow-xl">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <FaDollarSign className="text-[#16C79A] text-xl" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <label className="label text-[#16C79A]/80">Currency</label>
                <select
                  className="w-full px-4 py-3 bg-[#0d2c4a] border border-[#16C79A]/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#16C79A]"
                  value={settings.currency}
                  onChange={(e) => setSettings({...settings, currency: e.target.value})}
                >
                  <option value="USD" className="bg-[#0d2c4a]">USD ($)</option>
                  <option value="EUR" className="bg-[#0d2c4a]">EUR (€)</option>
                  <option value="SOS" className="bg-[#0d2c4a]">SOS (S)</option>
                </select>
              </div>
              
              <div>
                <label className="label text-[#16C79A]/80">Consultation Fee</label>
                <input
                  type="number"
                  className="w-full px-4 py-3 bg-[#0d2c4a] border border-[#16C79A]/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#16C79A]"
              ...
              <div>
                <label className="label text-[#16C79A]/80">Follow-up Fee</label>
                <input
                  type="number"
                  className="w-full px-4 py-3 bg-[#0d2c4a] border border-[#16C79A]/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#16C79A]"
          ...
          <div className="bg-gradient-to-br from-[#19456B] to-[#0d2c4a] border border-[#16C79A]/20 rounded-2xl p-6 shadow-xl">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <FaBell className="text-[#16C79A] text-xl" />
                <h3 className="text-xl font-semibold text-white">Notification Settings</h3>
              </div>
            </div>
            
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 rounded-lg hover:bg-gradient-to-r from-[#11698E]/10 to-[#19456B]/10 transition-all duration-300">
                <div>
                  <p className="font-medium text-white">Notify on New Appointment</p>
                  <p className="text-sm text-[#16C79A]/70">Send notification when new appointment is booked</p>
                </div>
              ...
              <div className="flex items-center justify-between p-3 rounded-lg hover:bg-gradient-to-r from-[#11698E]/10 to-[#19456B]/10 transition-all duration-300">
                <div>
                  ...
                  <p className="text-sm text-[#16C79A]/70">Send notification when appointment is cancelled</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
              ...
              <div className="flex items-center justify-between p-3 rounded-lg hover:bg-gradient-to-r from-[#11698E]/10 to-[#19456B]/10 transition-all duration-300">
                <div>
                  ...
                  <p className="text-sm text-[#16C79A]/70">Send SMS notifications to patients</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
          ...
          <div className="flex justify-end gap-4">
            ...
            <button
              onClick={handleSave}
              disabled={saving}
              className="px-6 py-3 bg-gradient-to-r from-[#16C79A] to-[#11698E] text-white rounded-xl hover:opacity-90 transition-all flex items-center gap-3"
            >
              {saving ? (
                <>
